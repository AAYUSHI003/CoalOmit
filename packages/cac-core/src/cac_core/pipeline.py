...
from cac_core.quantize.registry import get_quantizer
from cac_core.benchmark.accuracy import measure_accuracy, compare_accuracy
from cac_core.benchmark.latency import measure_latency
from cac_core.benchmark.energy import estimate_energy
from cac_core.carbon.grid_intensity import get_grid_intensity
from cac_core.carbon.projector import project_monthly_co2
from cac_core.report import CompressionResult, CACReport
...
def run_pipeline(
    ...
    return CACReport(results=results, config=config)
