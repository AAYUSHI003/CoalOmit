...
from comit_core.benchmark.accuracy import AccuracyResult
from comit_core.benchmark.latency import LatencyResult
from comit_core.benchmark.energy import EnergyResult
from comit_core.carbon.projector import CarbonProjection
...
class COMITReport:
    ...
    def __init__(self, results: List[CompressionResult], config: COMITConfig):
